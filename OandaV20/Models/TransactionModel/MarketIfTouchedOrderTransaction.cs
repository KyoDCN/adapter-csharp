...
{
    public class MarketIfTouchedOrderTransaction
    {
        ...
        public TransactionType Type; // MARKET_IF_TOUCHED_ORDER
        ...
        public MarketIfTouchedOrderTransaction()
        {
            ...
            this.Type = new TransactionType(ETransactionType.MARKET_IF_TOUCHED_ORDER);
        ...
        public MarketIfTouchedOrderTransaction(TransactionID id, DateTime time, int userID, AccountID accountID, TransactionID batchID, RequestID requestID, TransactionType type, InstrumentName instrument, double units, PriceValue price, PriceValue priceBound, TimeInForce timeInForce, DateTime gTDTime, OrderPositionFill positionFill, OrderTriggerCondition triggerCondition, MarketIfTouchedOrderReason reason, ClientExtensions clientExtensions, TakeProfitDetails takeProfitOnFill, StopLossDetails stopLossOnFill, TrailingStopLossDetails trailingStopLossOnFill, ClientExtensions tradeClientExtensions, OrderID replacesOrderID, TransactionID cancellingTransactionID)
        {
            this.Id = id;
            this.Time = time;
            this.UserID = userID;
