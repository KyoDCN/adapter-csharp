...
{
    public enum ETransactionRejectReason
    {
    ...
    {
        private ETransactionRejectReason Value;

        // CONSTRUCTORS
        public TransactionRejectReason()
        {
            this.Value = new ETransactionRejectReason();
        }
        public TransactionRejectReason(string value)
        {
            Set(value);
        }
        public TransactionRejectReason(ETransactionRejectReason value)
        {
            this.Value = value;
        }
        ...
        private bool Set(string value)
        {
            if (Enum.TryParse(value, out this.Value))
                ...
                throw new ArgumentException("Invalid Transaction Reject Reason", "Transaction Reject Reason Exception");
        }

        // IMPLICIT OPERATORS
        public static implicit operator TransactionRejectReason(ETransactionRejectReason value)
        {
            return new TransactionRejectReason(value);
        }
        public static implicit operator TransactionRejectReason(string value)
        {
            return new TransactionRejectReason(value);
        }
        public static implicit operator ETransactionRejectReason(TransactionRejectReason x)
        {
            return x.Value;
        }
