...
namespace OandaV20.Models.TransactionModel
{
    public class MarketOrderTransaction
    {
        ...
        public TransactionType Type { get; set; } // MARKET_ORDER
        public InstrumentName Instrument { get; set; }
        public double Units { get; set; }
        public TimeInForce TimeInForce { get; set; }
        public PriceValue PriceBound { get; set; }
        public OrderPositionFill PositionFill { get; set; } // DEFAULT
        ...
        public MarketOrderTransaction()
        {
            ...
            this.Type = new TransactionType(ETransactionType.MARKET_ORDER);
